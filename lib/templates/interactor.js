...
/*
 * Generates the basic code of an Interactor.
 */
export default class InteractorTemplate {
  constructor(options) {
  ...
  getPath() {
    return 'app/interactors/' + this.filenameFromClass() + '.rb'
  }

  filenameFromClass() {
    return this.interactorName.replace(/([A-Z])/g, "_$1")
                              .replace(/^_/,'')
                              .toLowerCase()
  }
