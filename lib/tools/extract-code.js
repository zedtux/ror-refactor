...
import PoroTemplate from '../templates/poro'
...
export default class ExtractCode {
  ...
  initializeServiceTemplate() {
    let serviceTemplate = atom.config.get('ror-refactor.serviceType')
    console.log('serviceTemplate: ' + serviceTemplate)
  ...
  createService() {
    ...
    this.initializeServiceTemplate()
  ...
  createPoro() {
    ...
    this.interactorTemplate = new PoroTemplate({
